            ...
            <section class="container mx-auto px-5 py-20 lg:py-32">
                <section class="flex flex-col lg:flex-row items-center gap-10">
                    ...
                    <section class="w-full lg:w-1/2 animate__animated animate__fadeInDown">
                        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold mb-5">Faiq Subhi <span
                                class="text-primary">Ramadlan</span></h1>
                    ...
                    <section class="w-full lg:w-1/2 flex justify-center animate__animated animate__fadeInUp">
                        <section
                            ...
                            <img src="{{ asset('assets/images/anggota/faiq.png') }}" alt="Reynaldi Ilham"
                ...
                <section class="flex flex-col lg:flex-row items-center gap-10">
                    ...
                    <section class="w-full lg:w-1/3">
                        <section class="border rounded-xl p-5 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg">
                            <img src="{{ asset('assets/images/anggota/faiq.png') }}" alt="Faiq Subhi Ramadlan Profile"
                                height="400px" class="w-full rounded-lg">
                            <section class="mt-5">
                                <h3 class="font-bold text-xl mb-2">Informasi Pribadi</h3>
                                <ul class="space-y-2 text-slate-500">
                                    <li class="flex items-center gap-2">
                                        <i class="fa-solid fa-calendar-days text-primary"></i>
                                        <span>TTL: Bogor, 13 Oktober 2005</span>
                                    </li>
                                    <li class="flex items-center gap-2">
                                    ...
                                    <li class="flex items-center gap-2">
                                        ...
                                        <span>Pendidikan: D4 Teknologi Rekayasa Komputer</span>
                                    </li>
                                    <li class="flex items-center gap-2">
                                        <i class="fa-solid fa-briefcase text-primary"></i>
                                        <span>Pengalaman: 1+ tahun</span>
                                    </li>
                                </ul>
                            </section>
                        </section>
                    ...
                    <section class="w-full lg:w-2/3">
                        ...
                        <div class="space-y-6 text-slate-500">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div class="border dark:border-gray-700 rounded-lg p-3 flex items-center gap-2">
                                    <i class="fa-brands fa-react text-primary text-xl"></i>
                                    <span>ReactJs</span>
                                </div>
                                <div class="border dark:border-gray-700 rounded-lg p-3 flex items-center gap-2">
                                ...
                                <div class="border dark:border-gray-700 rounded-lg p-3 flex items-center gap-2">
                                    <i class="fa-solid fa-golang text-primary text-xl"></i>
                                    <span>Golang</span>
                                </div>
                            </div>
                        </div>
